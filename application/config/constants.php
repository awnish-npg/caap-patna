...
define('ESCALATION_TIME', date('Y-m-d',strtotime('-2 days')));
define('ACTION_ITEMS', '1,4,6'); //1=>new Ticket, 4=>Resolve Tickets, 6=>Reopened
define('ACTION_ITEM_LIST', '10');
define('AR_ACTION_ITEMS', '5'); //3=>Closed, 5=>Rejected
define('SMS_API_URL', 'https://www.hawkfy.in/api/mt/SendSMS?user=MCGGGN&password=MCGGGN&senderid=MCGGGN&channel=Trans&DCS=8&flashsms=0'); //3=>Closed, 5=>Rejected
